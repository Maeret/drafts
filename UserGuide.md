...
Необязательное поле. Необходимо для того, чтобы камеры могли распознавать номер ТС сохранять его как Событие в «Ленте машин».
...
1. Перейти в раздел «Архив» -> «Камеры»;
2. Нажать на значок добавления:
![добавление камеры](add.jpg)
3. Ввести IP-адрес, присвоенный камере при установке (4.1);
4. Задать название камеры;
4. Подтвердить подключение – нажать «Создать».
