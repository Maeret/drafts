http://46.47.208.110
organisation_manager:5?59j4rBU90@ed$w - учетка суперадмина, права на все
security:security_service - учетка охраны - права на просмотр всего и хватит им
...
# 4. Администратору: подключение и редактирование камеры
...
## 4.2  Редактирование названия камеры
...
3. Перейти к редактированию (Рис. ):
...
3. Выбрать камеры из списка «Все камеры» и нажать стрелку (Рис.) – выбранные камеры переместятся в список «Доступные этой компании».
...
Чтобы отредактировать имя компании, пароль оператора и список доступных камер, нужно нажать на иконку редактирования напротив копании в списке (Рис.)
...
Чтобы отредактировать имя Роли и список доступных камер, нужно нажать на иконку редактирования напротив имени роли в списке (Рис.)
...
Профили пользователей, которые создают Гости, получают Роль «Гость». ___?___
...
Обязательное поле для профилей, которые создаются Гостями через гостевой терминал (2.2). Хранит ссылку на фото документа, удостоверяющего личность. Позволяет Администратору и Оператору просмотреть фото
...
Удалить Пользователя из списка или отредактировать его данные может только Администратор. Для этого нужно нажать на иконку редактирования напротив Пользователя в списке (Рис.)
...
Если снимок распознан, в поле «Пользователь» будет отображаться Имя (), Фамилию (), Должность (), которая указана в профиле существующего Пользователя (7), а в поле «Компания» – Компанию этого Пользователя.
